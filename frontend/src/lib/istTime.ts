 ...
 *  including) a day are anchored to the 09:15 session open, like NSE charts (1h = 09:15, 10:15 ... 15:15); shorter
 *  and longer intervals use plain epoch alignment. MUST match `bucket_start` in backend/app/charting.py. */
