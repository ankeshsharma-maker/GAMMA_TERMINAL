...
/** index underlyings: a tap goes straight to the chart (no sheet) */
const INDEX_RE = /^(NIFTY|BANKNIFTY|FINNIFTY|MIDCPNIFTY|NIFTYNXT50|SENSEX|BANKEX|SENSEX50)$/;

/** Tap a stock: its price, a big Chart button, and the symbol's OI views. */
      ...
      >
        <div className="flex items-start gap-2">
          <div className="min-w-0 flex-1">
            ...
            <div className="text-[11px] text-term-dim">Stock</div>
          </div>
